# Care Passport — MVP Development Brief
...
The MVP is being validated with people entering residential aged care, however the architecture, data model, language and outputs must remain suitable for broader support contexts including disability support, home care, rehabilitation, hospital care, respite care and community support.

Avoid hard-coding aged-care-specific assumptions into the platform.
...
Care Passport helps people and families create a person-centred identity and support package.

It is not a clinical care plan and must not frame outputs as instructions to staff, carers or support workers.

The app helps produce:
...
2. User creates a person/resident profile.
